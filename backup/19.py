...
class ScrabbleGame:
    def __init__(self):
        ...
        pygame.display.set_caption("SCRABBLE PRO - Wersja z Naprawionym Stojakiem")
    ...
    def recalculate_dimensions(self):
        ...
        # Stojaki odsunięte o 1 kafel od planszy
    ...
    def handle_exchange(self):
        ...
        if not self.exchange_mode:
            ...
            self.exchange_mode = True; self.exchange_selected = []; self.calc_text = "Zaznacz i kliknij WYMIANA"
        else:
    ...
    def end_game(self, manual=False):
        ...
        if s1 > s2: self.winner_text = f"WYGRAŁ {self.player_names[1]}!"
        elif s2 > s1: self.winner_text = f"WYGRAŁ {self.player_names[2]}!"
