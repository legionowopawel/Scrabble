...
class ScrabbleEngine:
    ...
    def commit_move(self):
        ...
        # print definition to terminal truncated to 400 chars
...
class ScrabbleApp:
    ...
    def update_fonts(self):
        ...
        # font used for bonuses and now also for "Słowo" labels and their words
    ...
    def draw_board(self):
        ...
        # show only the words (no definitions)
    ...
    def draw_log_window(self):
        ...
        for line in self.log_lines[-6:][::-1]:
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN:
                ...
                if self.engine.turn == "PLAYER":
                    ...
                    if self.ok_btn.collidepoint(pos):
                        ...
                        print(msg)
                        if ok:
                            # log words only; definitions printed to terminal
